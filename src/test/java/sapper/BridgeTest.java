...
public class BridgeTest {
	...
	public void changeFieldFlagStatusTest(int sizeX, int sizeY, int numberOfMines, int[][] mines, boolean expectedReturnValue,int clicX,int clicY){
		Bridge bridge=new Bridge(sizeX,sizeY,numberOfMines,mines);
	...
	public void chackMineFlagTest(int sizeX, int sizeY, int numberOfMines, int[][] mines,MineNumberWinLose expectedReturnValue,int clicX,int clicY,int checkX,int checkY){
		Bridge bridge=new Bridge(sizeX,sizeY,numberOfMines,mines);
